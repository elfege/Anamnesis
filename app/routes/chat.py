...
def _maybe_friendly_d2_error(status_code: int, body: str) -> Optional[str]:
    ...
    if status_code == 503 and (
        ...
        return (
            ...
            "**Option 2:** If you already trained a personal run, open the dashboard's "
            "**δ² → Personal Benchmarks** panel and click **Load for chat** on the "
            "adapter card you want. It hot-loads the LoRA in ~10 s and routes this "
            "chat through it. Closing the chat tab auto-unloads to free VRAM.\n\n"
